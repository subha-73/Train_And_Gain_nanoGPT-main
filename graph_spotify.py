...
log_file = 'training_log_spotify.txt'
...
plt.plot(train_iters, train_losses, label='Training Loss', color='blue', alpha=0.6)
plt.plot(val_iters, val_losses, label='Validation Loss', color='orange', marker='o')
